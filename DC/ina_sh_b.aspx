<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'view_inas', t_bbsTag = 'tbbs', t_content = " ", afilter = [], bbsKey = ['noa'], as;
            var t_sqlname = '';
            t_postname = q_name;
            var isBott = false;
		...
		<div  id="dbbs"  >
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<th align="center"><a id=''>入庫單號/項次</a></th>
					<th align="center"><a id=''>品名</a></th>
					<th align="center"><a id=''>計價單位</a></th>
					<th align="center"><a id=''>計價量(面積)</a></th>
					<th align="center"><a id=''>貨物單位</a></th>
					<th align="center"><a id=''>貨物數量</a></th>
					<th align="center"><a id=''>儲位</a></th>
				</tr>
				<tr  style='background:#cad3ff;'>
					...
					<td style="width:170px;" align="center">
						...
						<input id="txtNoq.*" type="text" style="float:left;width:30%;"  readonly="readonly" />
					</td>
                    ...
                    <td style="width:70px;">
                        <input id="txtSpec.*" type="text" style="float:left;width:95%;" readonly="readonly"/>
                    </td>
					<td style="width:90px;">
                        <input id="txtMweight.*" type="text" style="float:left;text-align:right;width:95%;" readonly="readonly"/>
                    </td>
					<td style="width:70px;">
						<input id="txtUnit.*" type="text" style="float:left;width:95%;" readonly="readonly"/>
                    </td>
                    <td style="width:90px;">
